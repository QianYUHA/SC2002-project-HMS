 ...
 * Provides the entry point to the system and handles user interactions, role-based logins, 
 * and navigation between system functionalities.
 */
public class Main {
    ...
    private static boolean handleDoctorActions(Doctor doctor, int choice, Scanner scanner, AppointmentManager appointmentManager) {
        switch (choice) {
            ...
            case 5:
                ...
                boolean h1 = doctor.viewUpcomingAppointments();
                ...
                if (h1){
                    ...
                    if (response.equalsIgnoreCase("no")){
                        ...
                        System.out.println("Invalid Choice. Enter either (yes/no).");
                    }
                }
                break;
            case 6:
            ...
            case 7:
                ...
                boolean h2 = doctor.viewConfirmedAppointments();
                if (h2){
