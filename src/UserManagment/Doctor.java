 ...
 */
    ...
    public void updatePatientMedicalRecord(Patient patient, String appointmentID) {
        ...
        // Access the patient's medical record and add an entry
        MedicalRecord medicalRecord = patient.getMedicalRecord();
        if (medicalRecord != null) {
            medicalRecord.addMedicalRecordEntry(appointmentID, diagnosis, treatmentPlan);
            System.out.println("Medical record updated successfully for Appointment ID: " + appointmentID);
        } else {
            System.out.println("Failed to update medical record. Patient's medical record not found.");
        }
    }
